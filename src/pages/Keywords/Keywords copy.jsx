...
const Keywords = () => {
    ...
    const pieChartData = useMemo(() => {
        ...
        const othersVolume = sortedVolumes.slice(7).reduce((acc, curr) => acc + curr.volume, 0);
    ...
    const pieColors = ['#8884d8', '#82ca9d', '#ffc658', '#d84a8b', '#4da8d8', '#a84d58', '#d8a84d', '#cccccc'];
    ...
    return (
        <div className="keywords-container">
            ...
            <Box sx={{ width: '100%', height: 400, marginBottom: 4 }}>
                <h2>Bar Chart - Apollo Search Volume by Year and Quarter</h2>
            ...
            {/* Pie Chart */}
            <Box sx={{ width: '100%', height: 400, marginBottom: 4 }}>
                <h2>Pie Chart - Keyword Share (2024)</h2>
                <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                        <Pie
                            data={pieChartData}
                ...
                <Table aria-label="keyword data table">
                    ...
                    <TableBody>
                        {pieChartData.map((row, index) => (
                            <TableRow key={index}>
                                <TableCell component="th" scope="row">{row.keyword_title}</TableCell>
